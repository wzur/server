...
/**
 * This class defines the structure of the 'node_server' table.
 *
 *
 *
 ...
 */
class NodeServerTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Core.NodeServerTableMap';
	...
	{
	  // attributes
		$this->setName('node_server');
		$this->setPhpName('NodeServer');
		$this->setClassname('NodeServer');
