...
/**
 * This class defines the structure of the 'remote_server' table.
 *
 *
 *
 ...
 */
class RemoteServerTableMap extends TableMap {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'Core.RemoteServerTableMap';
	...
	{
	  // attributes
		$this->setName('remote_server');
		$this->setPhpName('RemoteServer');
		$this->setClassname('RemoteServer');
